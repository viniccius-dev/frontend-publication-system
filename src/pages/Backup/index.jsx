...
//                             <p style={{ marginBottom: 12 }}>Selecione um arquivo de backup (.zip) para importar.</p>
//                             <div style={{ marginBottom: 0, marginTop: -16 }}>
//                                 <Uploads onFilesChange={handleFilesChange} />
//                             </div>

//                             {/* Removido campo de input em branco abaixo do Uploads */}
//                             <Preview style={{ minHeight: 40, marginBottom: 0 }}>
//                                 {previewInfo && (
//                                     <div>
//                                         <ul>
//                                             {previewInfo.map((p, i) => (
...
//                                     <Button title="Confirmar Importação" onClick={handleConfirmImport} loading={loading} style={{ maxWidth: 240, width: '100%' }} />
//                                 </div>
//                             </Actions>
//                         </Section>
//                     </Column>
...
export function Backup() {
  ...
  const [frequency, setFrequency] = useState(
    () => localStorage.getItem('@backup:frequency') || 'never'
  );
